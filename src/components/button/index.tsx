    ...
    <>
      {type === 'primary' ? (
        <button
          onClick={onClick}
          type='submit'
          className='w-3 md:w-full border bg-blue500 text-white rounded-md text-base font-bold px-16 md:px-8 md:py-2.5 hover:bg-blue500/90 transition-all duration-300'
        >
          {text}
        </button>
      ) : type === 'secondary' ? (
